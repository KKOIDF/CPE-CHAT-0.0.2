...
Generated: 2026-04-16T18:44:42.297594
...
### Latency Metrics
- avg total latency ms: 474.40
- median total latency ms: 302.70
- p95 total latency ms: 1447.73
- avg retrieval latency ms: 1640.33
- median retrieval latency ms: 1163.94
- p95 retrieval latency ms: 5208.91
- avg generation latency ms: 183.92
- median generation latency ms: 145.18
- p95 generation latency ms: 423.48
...
- announcements: total=8, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=1116.19, p95_latency_ms=1648.98
- curriculum: total=19, overall=0.9474, answer=0.9474, retrieval=1.0000, citation=1.0000, avg_latency_ms=156.70, p95_latency_ms=262.86
- multi: total=3, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=637.23, p95_latency_ms=786.60
- regulations: total=10, overall=0.9000, answer=0.9000, retrieval=1.0000, citation=1.0000, avg_latency_ms=515.75, p95_latency_ms=1050.13
...
- curriculum_009 (curriculum_fact_lookup): coverage=0.67, retrieval=True, citation=True, must_not=True, latency_ms=90.7, tags=retrieve_found_but_answer_incomplete, error=none
- typo_002 (typo_noisy_query): coverage=0.67, retrieval=True, citation=True, must_not=True, latency_ms=462.3, tags=retrieve_found_but_answer_incomplete, error=none
