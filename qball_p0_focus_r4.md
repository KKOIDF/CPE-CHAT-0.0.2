...
Generated: 2026-04-16T18:08:21.470073
...
- top-K hit rate: 0.4000
- mean reciprocal rank (mrr): 0.0784
...
### Latency Metrics
- avg total latency ms: 224.06
- median total latency ms: 112.43
- p95 total latency ms: 517.46
- avg retrieval latency ms: 1819.58
- median retrieval latency ms: 1700.59
- p95 retrieval latency ms: 2523.32
...
- curriculum: total=3, overall=0.0000, answer=0.3333, retrieval=0.3333, citation=1.0000, avg_latency_ms=163.52, p95_latency_ms=279.71
- multi: total=1, overall=0.0000, answer=0.0000, retrieval=0.0000, citation=0.0000, avg_latency_ms=112.27, p95_latency_ms=112.27
- regulations: total=1, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=517.46, p95_latency_ms=517.46
...
- multi_003 (multi_intent_multi_doc): coverage=0.00, retrieval=False, citation=False, must_not=False, latency_ms=112.3, tags=retrieve_not_found,context_conflict,hallucination, error=none
- prereq_003 (prerequisite_course_code): coverage=0.50, retrieval=False, citation=True, must_not=True, latency_ms=112.4, tags=retrieve_not_found, error=none
- prereq_001 (prerequisite_course_code): coverage=0.50, retrieval=True, citation=True, must_not=True, latency_ms=279.7, tags=retrieve_found_but_answer_incomplete, error=none
- prereq_002 (prerequisite_course_code): coverage=1.00, retrieval=False, citation=True, must_not=True, latency_ms=98.4, tags=retrieve_not_found, error=none
