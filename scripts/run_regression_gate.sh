...
GATE_MIN_EXACTNESS="${GATE_MIN_EXACTNESS:-0.02}"
GATE_MIN_CITATION_VALIDITY="${GATE_MIN_CITATION_VALIDITY:-0.00}"
GATE_MAX_LATENCY_P95="${GATE_MAX_LATENCY_P95:-20500}"
...
GATE_MIN_CASES_PER_GROUP="${GATE_MIN_CASES_PER_GROUP:-6}"
