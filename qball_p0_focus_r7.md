...
Generated: 2026-04-16T18:35:36.111156
...
### Latency Metrics
- avg total latency ms: 355.19
- median total latency ms: 231.37
- p95 total latency ms: 804.74
- avg retrieval latency ms: 1488.00
- median retrieval latency ms: 1110.01
- p95 retrieval latency ms: 2850.56
...
- curriculum: total=3, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=157.05, p95_latency_ms=231.37
- multi: total=1, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=804.74, p95_latency_ms=804.74
- regulations: total=1, overall=1.0000, answer=1.0000, retrieval=1.0000, citation=1.0000, avg_latency_ms=500.07, p95_latency_ms=500.07

## By Category

- multi_intent_multi_doc: total=1, overall=1.0000, answer=1.0000, retrieval=1.0000, top1=0.0000, top3=0.0000, top5=0.0000, citation=1.0000
- prerequisite_course_code: total=3, overall=1.0000, answer=1.0000, retrieval=1.0000, top1=0.0000, top3=1.0000, top5=1.0000, citation=1.0000
- regulations: total=1, overall=1.0000, answer=1.0000, retrieval=1.0000, top1=0.0000, top3=0.0000, top5=0.0000, citation=1.0000

## Error Tag Counts

- pass_or_unclassified: 5
